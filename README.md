...
This app provides an easy to use authenticated area to keep track of business contacts/clients.
...
After confirming that your development environment meets the specified [requirements](#requirements), you can create a new project based on `micro-crm-client` by doing the following:
...
```bash
$ git clone https://github.com/successkrisz/micro-crm-client.git <my-project-name>
$ cd <my-project-name>
```
...
## Deployment
Out of the box, Micro CRM Client is deployable by serving the `~/dist` folder generated by `npm run deploy` (make sure to specify your target `NODE_ENV` as well). This project does not concern itself with the details of server-side rendering or API structure, since that demands an opinionated structure that makes it difficult to extend the starter kit. However, if you do need help with more advanced deployment strategies, here are a few tips:
